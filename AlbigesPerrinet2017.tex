...
\begin{figure}[!h]
\centering{\includegraphics[width=0.7\linewidth]{unproc_fig.png}}
...
\begin{figure}[!h]
\centering{\includegraphics[width=0.7\linewidth]{proc_fig.png}}
...
\begin{figure}[!h]
\centering{\includegraphics[width=0.5\linewidth]{eventRetina_capture.png}}
...
\begin{figure}[!h]
\centering{\includegraphics[width=0.3\linewidth]{raspberrypi.jpg}}
...
La biomimétique consiste en la \textbf{reproduction de fonctions et de capacités des systèmes biologiques dans des systèmes artificiels} afin d'améliorer leurs performances.\\
...
Dans le cadre de ce projet, c'est la \textbf{rétine et le système visuel animal} qui servent de modèle.\\
\FigureBiomimetism
...
Dans le cadre de OpenRetina, c'est une \textbf{ingénerie low-tech et Open Source} qui est visée, afin de permettre son adaptation et son utilisation par le plus de systèmes possible.\\
...
Cette étape est proche d'une prise d'image classique mais sert surtout à récupérer les  \textbf{informations enregistrées individuellement dans chaque pixel}.\\
\FigureUnprocPic\\

\subsection*{Process}
\rule[40ex]{10cm}{1pt}\\
Réaliser un traitement sur chaque frame que comporte l'image, afin de \textbf{réduire la quantité d'informations transmises et d'accélerer la temporalité de la perception, sans perte de résolution}.\\
\FigureProcPic
