...
L'ingénierie biomimétique est régulièrement utilisé dans le développement de technologies de pointe comme la robotique, mais aussi dans la recherche car il permet de mieux comprendre les mécanismes biologiques étudies.\\
