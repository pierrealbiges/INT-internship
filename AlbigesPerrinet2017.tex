...
%\newcommand{\InstituteA}{Aix Marseille Univ, CNRS,\\ INT, Inst Neurosciences Timone\\ Marseille, France}%
%\newcommand{\InstituteB}{Aix Marseille Univ, CNRS,\\ ISM, Inst Movement Sci,\\ Marseille, France}%
%\newcommand{\InstituteC}{Aix Marseille Univ, CNRS,\\ INT, Inst Neurosciences Timone\\ Marseille, France}%{Institut de Neurosciences de la Timone\\  (UMR7289) \\ CNRS / Aix-Marseille Universit\'e}%
...
This work was supported by the Doc2Amu project which received funding from a co-fund with the European Union's Horizon 2020 research and innovation programme and the region Provence Alpes Cote d'Azur. Correspondence and requests for materials should be addressed to LUP (email:\EmailC ). Code and supplementary material available at \url{\WebsiteC/Publications/BoutinRuffierPerrinet17neurofrance}. %spars}.
} %
