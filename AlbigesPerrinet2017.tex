...
\centering{
\begin{tikzpicture}
\draw [anchor=north west] (0, .9\linewidth) node {\includegraphics[width=.8\linewidth]{unproc_fig.png}};
...
grab (picam, cam ou video)\\
\FigureUnprocPic
process (réduire la quantité d'informations transmises afin d'accélerer la temporalité de la perception)\\
networking\\
displaying
}
